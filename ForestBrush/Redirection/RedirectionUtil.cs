...
namespace ForestBrush.Redirection
{
    public class NameOf
    {
    ...
    public static class RedirectionUtil
    {
        ...
        private static void RedirectMethods(Type type, Type targetType, Dictionary<MethodInfo, RedirectCallsState> redirects, bool onCreated)
        {
            ...
            {
                Debug.Log("Redirecting " + targetType.Name + "#" + method.Name);
                        ...
                        }))
            {
                ...
                if (getMethod != null)
                {
                    Debug.Log("Redirecting " + targetType.Name + "#" + getMethod.Name);
                ...
                if (setMethod != null)
                {
                    Debug.Log("Redirecting " + targetType.Name + "#" + setMethod.Name);
        ...
        private static void RedirectReverse(Type type, Type targetType, Dictionary<MethodInfo, RedirectCallsState> redirects, bool onCreated)
        {
            ...
            {
                Debug.Log("Redirecting reverse " + targetType.Name + "#" + method.Name);
                        ...
                        }))
            {
                ...
                if (getMethod != null)
                {
                    Debug.Log("Redirecting reverse " + targetType.Name + "#" + getMethod.Name);
                ...
                if (setMethod != null)
                {
                    Debug.Log("Redirecting reverse " + targetType.Name + "#" + setMethod.Name);
